...
export const APPSHOT_GET_STATUS_CHANNEL = "desktop:appshot-get-status";
export const APPSHOT_CONFIGURE_SHORTCUT_CHANNEL = "desktop:appshot-configure-shortcut";
export const APPSHOT_REQUEST_CHANNEL = "desktop:appshot-request";
export const APPSHOT_CAPTURE_CHANNEL = "desktop:appshot-capture";
export const APPSHOT_REQUESTED_CHANNEL = "desktop:appshot-requested";
