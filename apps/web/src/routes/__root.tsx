...
import { DesktopUpdateConflictDispatcher } from "../components/DesktopUpdateConflictDispatcher";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <DesktopUpdateConflictDispatcher /> : null}
